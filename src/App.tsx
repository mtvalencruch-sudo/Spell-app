...
export default function App() {
  ...
  const handleUnlockTeacher = (code) => {
  ...
  const handleChangeTeacherCode = (newCode) => {
  ...
  const handleFinishSession = (completedWords) => {
    if (!activeSet) return;
  ...
  const handleSaveHistory = (completedWords) => {
    if (!activeSet) return;
  ...
  const handleImportSets = (imported) => {
    Promise.all(
      imported.map((set) =>
              ...
              >
                ...
                <form
                  onSubmit={(e) => {
                    ...
                    const codeVal = (form.elements.namedItem("passcode")).value;
            ...
            {isTeacher ? (
              <div className="flex items-center gap-2 animate-fade-in">
                <button
                  ...
                  className={`px-3 py-1.5 rounded-xl border text-xs font-bold flex items-center gap-1.5 shadow-xs cursor-pointer transition ${activeTab === "teacher"
                    ...
                    <div className="flex flex-wrap justify-center gap-1.5">
                      {wordSets.map((set) => (
                        <button
                          ...
                          className={`text-[10px] font-mono font-bold px-2 py-1 rounded border transition uppercase tracking-wider cursor-pointer ${activeSet?.code === set.code
      ...
      <footer className="sticky bottom-0 bg-white dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800/80 px-4 py-3 select-none">
        <div className="max-w-md mx-auto flex items-center justify-around gap-2">
          ...
          <button
            ...
            className={`flex flex-col items-center gap-1 p-2 rounded-xl text-center w-20 transition cursor-pointer ${activeTab === "dashboard"
          ...
          <button
            ...
            className={`flex flex-col items-center gap-1 p-2 rounded-xl text-center w-20 transition cursor-pointer ${activeTab === "newset"
              ? "text-indigo-600 dark:text-indigo-400 font-extrabold"
              : "text-slate-400 hover:text-slate-600 dark:hover:text-slate-200"
              }`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center gap-1 p-2 rounded-xl text-center w-20 transition cursor-pointer ${activeTab === "practice"
              ? "text-indigo-600 dark:text-indigo-400 font-extrabold"
              : "text-slate-400 hover:text-slate-600 dark:hover:text-slate-200"
              }`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center gap-1 p-2 rounded-xl text-center w-20 transition cursor-pointer ${activeTab === "wordsets"
              ? "text-indigo-600 dark:text-indigo-400 font-extrabold"
              : "text-slate-400 hover:text-slate-600 dark:hover:text-slate-200"
              }`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center gap-1 p-2 rounded-xl text-center w-20 transition cursor-pointer ${activeTab === "progress"
              ? "text-indigo-600 dark:text-indigo-400 font-extrabold"
              : "text-slate-400 hover:text-slate-600 dark:hover:text-slate-200"
              }`}
          >
          ...
          {isTeacher && (
            <button
              ...
              className={`flex flex-col items-center gap-1 p-2 rounded-xl text-center w-20 transition cursor-pointer ${activeTab === "teacher"
                ? "text-indigo-600 dark:text-indigo-400 font-extrabold"
                : "text-slate-400 hover:text-slate-600 dark:hover:text-slate-200"
                }`}
            >
